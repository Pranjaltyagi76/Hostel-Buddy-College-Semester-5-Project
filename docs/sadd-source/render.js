// Render sadd.html -> PDF using headless Chrome + CDP (Node 24 built-in WebSocket).
...
const htmlPath = path.resolve(__dirname, 'sadd.html');
const outPath = path.resolve(__dirname, 'Group_19_Hostel_Buddy_SADD.pdf');
